...
export function PlayerPanel({
  ...
  return (
    <div className="lg:w-80 w-full flex flex-col gap-4">
      <div className="rounded-2xl p-5 flex flex-col gap-4" style={{ background: C.panel, border: `1px solid ${C.line}` }}>
      ...
      <div className="rounded-2xl p-5" style={{ background: C.panel, border: `1px solid ${C.line}` }}>
        ...
        <Scoreboard players={players} scores={scores} youId={youId} />
      </div>
    </div>
  );
}
